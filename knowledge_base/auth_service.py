...
# This is the scope that our application will request from the user.
# We need read/write access to their calendar.
...
class AuthService:
    def get_google_auth_flow(self):
        ...
        The flow is configured using environment variables for security.
        """
        client_config = {
            "web": {
    ...
    def get_authorization_url(self):
        ...
        # which is useful for development to always get a refresh token.
    ...
    def fetch_token(self, authorization_response: str):
        ...
        # The credentials object (flow.credentials) now contains the access and refresh tokens.
        # We need to convert it to a JSON string to store it in the database.
